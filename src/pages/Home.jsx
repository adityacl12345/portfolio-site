    ...
    return (
        <div className="py-10">
            ...
            <section className={`${sectionClass} my-10`}>
                ...
                {showDocs && (
                    <div className="mt-4 flex flex-wrap justify-center gap-4" ref={docsRef}>
                        <a
                        ...
                        >
                            <span>Freaks 4U Reference </span><FiDownload size={16} className="inline" />
                        </a>
                        <a
                            ...
                            className="px-4 py-2 bg-zinc-800 text-white rounded hover:bg-zinc-900"
                        >
                            <span>Gamigo Reference </span><FiDownload size={16} className="inline" />
                        </a>
                        <a
                        ...
                        >
                             <span>Master's Degree </span><FiDownload size={16} className="inline" />
                        </a>
                    </div>
                )}
            </section>
            ...
            <section ref={contactRef} id="contact" className={`${sectionClass} my-10`}>
